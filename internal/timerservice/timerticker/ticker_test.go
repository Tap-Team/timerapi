...
import (
	...
	"github.com/Tap-Team/timerapi/internal/timerservice/timerticker"
...
func TestAddRemove(t *testing.T) {
	...
	require.ErrorIs(t, err, timererror.ExceptionTimerExists())
	...
	require.ErrorIs(t, err, timererror.ExceptionWrongTimerTime())
}
