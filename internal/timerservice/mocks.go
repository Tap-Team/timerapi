...
func (m *MockTimerServiceClient) Update(ctx context.Context, timerId uuid.UUID, endTime int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", ctx, timerId, endTime)
	ret0, _ := ret[0].(error)
	return ret0
}

// Update indicates an expected call of Update.
func (mr *MockTimerServiceClientMockRecorder) Update(ctx, timerId, endTime interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockTimerServiceClient)(nil).Update), ctx, timerId, endTime)
}
