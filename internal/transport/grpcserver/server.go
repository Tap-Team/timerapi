...
type Services struct {
	NotificationService notificationservicepb.NotificationServiceServer
}
...
func (s *Server) RegisterServices() {
	notificationservicepb.RegisterNotificationServiceServer(s, s.services.NotificationService)
}
